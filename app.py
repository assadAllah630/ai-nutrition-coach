...
app = Flask(__name__)
app.secret_key = os.getenv("FLASK_SECRET_KEY", "your-secret-key-here")  # Set a secure secret key

credentials = Credentials(
    url="https://us-south.ml.cloud.ibm.com",
    api_key=os.getenv("IBM_WATSON_API_KEY")  # Set your API key as environment variable
)
client = APIClient(credentials)
model_id = "meta-llama/llama-4-maverick-17b-128e-instruct-fp8"
project_id = os.getenv("IBM_WATSON_PROJECT_ID")  # Set your project ID as environment variable
